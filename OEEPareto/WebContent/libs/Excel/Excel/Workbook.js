...
//                console.log("Called back by the worker!\n", event.data);
        ...
        generateFiles: function () {
          ...
          //files["/xl/worksheets/sheet1.xml"] = "<?xml version='1.0' encoding='UTF-8' standalone='yes'?> <worksheet xmlns='http://schemas.openxmlformats.org/spreadsheetml/2006/main' xmlns:r='http://schemas.openxmlformats.org/officeDocument/2006/relationships' xmlns:mc='http://schemas.openxmlformats.org/markup-compatibility/2006'><dimension ref='A1:C7'/><cols><col max='1' min='1' customWidth='1' width='16'/><col max='2' min='2' customWidth='1' width='17'/><col max='3' min='3' customWidth='1' width='7'/></cols><sheetData><row r='1'><c t='s' r='A1'><v>0</v></c><c t='s' r='B1'><v>1</v></c><c t='s' r='C1'><v>2</v></c></row><row r='2'><c t='s' r='A2'><v>3</v></c><c t='s' r='B2'><v>4</v></c><c r='C2'><v>8.99</v></c></row><row r='3'><c t='s' r='A3'><v>3</v></c><c t='s' r='B3'><v>5</v></c><c r='C3'><v>13.99</v></c></row><row r='4'><c t='s' r='A4'><v>3</v></c><c t='s' r='B4'><v>6</v></c><c r='C4'><v>11.34</v></c></row><row r='5'><c t='s' r='A5'><v>7</v></c><c t='s' r='B5'><v>8</v></c><c r='C5'><v>10.54</v></c></row><row r='6'><c t='s' r='A6'><v>7</v></c><c t='s' r='B6'><v>9</v></c><c r='C6'><v>10.64</v></c></row><row r='7'><c t='s' r='A7'><v>7</v></c><c t='s' r='B7'><v>10</v></c><c r='C7'><v>8.99</v></c></row></sheetData><drawing r:id='rId14'/><tableParts count='1'><tablePart r:id='rId13'/></tableParts></worksheet>";
            console.log(files);
            return files;
        }
    });
